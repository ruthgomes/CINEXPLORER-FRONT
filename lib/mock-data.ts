...
export const mockCinemas: Cinema[] = [
  ...
  {
    id: "2",
    name: "CineXplorer Paulista",
    address: "Rua Augusta, 1475 - Consolação, São Paulo - SP",
    imageUrl: "/placeholder.svg?height=300&width=600",
    roomTypes: ["2D", "3D", "VIP"],
    rating: 4.6,
    reviewCount: 987,
  ...
  {
    id: "4",
    name: "CineXplorer Savassi",
    address: "Rua Pernambuco, 1197 - Savassi, Belo Horizonte - MG",
    imageUrl: "/placeholder.svg?height=300&width=600",
    roomTypes: ["2D", "3D", "VIP"],
    rating: 4.5,
    reviewCount: 876,
  ...
  {
    id: "5",
    name: "CineXplorer Iguatemi",
    address: "Av. Faria Lima, 2232 - Jardim Paulistano, São Paulo - SP",
    imageUrl: "/placeholder.svg?height=300&width=600",
  ...
  {
    id: "6",
    name: "CineXplorer Brasília",
    address: "SHN Q 5 BL J - Asa Norte, Brasília - DF",
    imageUrl: "/placeholder.svg?height=300&width=600",
    roomTypes: ["2D", "3D", "4DX"],
    rating: 4.4,
    reviewCount: 743,
